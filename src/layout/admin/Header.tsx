    ...
    <Fragment>
      ...
      <Navbar
        ...
        <div className={`flex items-center justify-between`}>
          ...
          <ProfileMenu
            profileImg={profilePic ?? 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80'}
