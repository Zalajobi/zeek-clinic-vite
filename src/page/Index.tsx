    ...
    <Fragment>
      <div className="relative grid min-h-[100vh] w-screen p-8">
        ...
        <div className="flex-col gap-2 pt-56 pb-40 text-center">
          ...
          <CustomTypography variant="p" className="opacity-70">
        ...
        <div className="grid grid-cols-1 gap-4 self-end md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            >
              <CustomTypography
                variant="h5"
                weight="bold"
                className="mb-3 flex items-center gap-3 text-black"
              >
                <svg
              ...
              <CustomTypography variant="p" className="font-normal opacity-70">
          ...
          >
            ...
            >
              ...
              <CustomTypography className="font-normal opacity-70" variant="p">
